...
if(isset($_POST['submitadminCode'])) {
    ...
    // Fetch admin details
    $query_code = "SELECT * FROM admins_verification WHERE verify_token = '$otp' AND admin_email = '$email'";
    ...
    if(mysqli_num_rows($run_query_code) > 0) {
        ...
        if(mysqli_query($con, $insert_admin)) {
            ...
            echo "<script>
                    alert('Failed to insert into admin table');
