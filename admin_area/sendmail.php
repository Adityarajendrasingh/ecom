...
if(isset($_POST['submit_admin_form'])) {
    ...
    $check_cust = "select * from admin where admin_email = '$admin_email'";
    ...
    $insert_q = "insert into admins_verification (admin_name, admin_email, admin_pass, admin_country, admin_contact, admin_image, admin_temp_image, verify_token, admin_job, admin_about) values('$admin_name','$admin_email', '$admin_pass','$admin_country','$admin_contact','$admin_image','$temp_admin_image','$verify_token','$admin_job','$admin_about')";
