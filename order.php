...
while($row_cart = mysqli_fetch_array($run_cart)) {
    ...
    while($row_pro = mysqli_fetch_array($run_product)) {
        ...
        $insert_customer_order="insert into customer_order (customer_id, due_amount, invoice_no, qty, size, order_date, order_status) values('$customer_id','$sub_total','$invoice_no','$pro_qty','$pro_size',NOW(),'$status')";
